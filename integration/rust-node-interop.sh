...
(
  ...
  go build -o "${work_dir}/go-node" ./cmd/lanewayd
...
rust_a_pid="${last_pid}"
start_process "${node_b_ns}" "${work_dir}/go-b.log" "${work_dir}/go-node" -config "${work_dir}/go-b.toml"
go_b_pid="${last_pid}"
...
rust_a_pid="${last_pid}"
start_process "${node_b_ns}" "${work_dir}/go-b-rust-relay.log" "${work_dir}/go-node" -config "${work_dir}/go-b.toml"
go_b_pid="${last_pid}"
...
rust_a_pid="${last_pid}"
start_process "${node_b_ns}" "${work_dir}/go-b-rust-tcp.log" "${work_dir}/go-node" -config "${work_dir}/go-b.toml"
go_b_pid="${last_pid}"
...
rust_a_pid="${last_pid}"
start_process "${node_b_ns}" "${work_dir}/go-b-subnet.log" "${work_dir}/go-node" -config "${work_dir}/go-b-subnet.toml"
go_b_pid="${last_pid}"
...
rust_a_pid="${last_pid}"
start_process "${node_b_ns}" "${work_dir}/go-b-exit.log" "${work_dir}/go-node" -config "${work_dir}/go-b-exit-targets.toml"
go_b_pid="${last_pid}"
...
start_process "${node_b_ns}" "${work_dir}/go-b-direct.log" "${work_dir}/go-node" -config "${work_dir}/go-b-direct.toml"
go_b_pid="${last_pid}"
