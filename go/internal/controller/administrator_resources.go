...
var (
	...
	administratorAccessResourceCreatePolicy      = mustAdministratorResourcePolicy(http.MethodPost, "/v1/admin/networks/{network_id}/resources")
	administratorAccessResourceUpdatePolicy      = mustAdministratorResourcePolicy(http.MethodPatch, "/v1/admin/resources/{resource_id}")
	administratorAccessServiceCreatePolicy       = mustAdministratorResourcePolicy(http.MethodPost, "/v1/admin/networks/{network_id}/services")
	administratorAccessServiceUpdatePolicy       = mustAdministratorResourcePolicy(http.MethodPatch, "/v1/admin/services/{service_id}")
	administratorAccessResourceGrantCreatePolicy = mustAdministratorResourcePolicy(http.MethodPost, "/v1/admin/networks/{network_id}/resource-access-grants")
	administratorAccessResourceGrantDeletePolicy = mustAdministratorResourcePolicy(http.MethodDelete, "/v1/admin/resource-access-grants/{grant_id}")
