...
func TestOpenMigratesAndConfiguresSQLite(t *testing.T) {
	...
	for _, table := range []string{"networks", "nodes", "certificates", "overlay_addresses", "routes", "acl_rules", "relays", "enrollment_tokens", "audit_events", "access_users", "access_teams", "access_team_members", "access_grants", "controller_identity_state", "endpoint_status_latest", "access_resources", "access_services", "access_service_ports", "access_resource_grants", "schema_versions"} {
		var found string
