...
if (registered.size !== 54) problems.push(`controller registration count is ${registered.size}, expected 54`);
if (documented.size !== 54) problems.push(`OpenAPI operation count is ${documented.size}, expected 54`);
...
console.log('Management contract has unique YAML keys and matches all 54 registered administrator routes.');
